...
process.env.APPLICATIONINSIGHTS_CONNECTION_STRING =
  "InstrumentationKey=6f15a2b0-1e6e-4f3e-bb8a-1e05f29a0abc;IngestionEndpoint=https://eastus-1.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus.livediagnostics.monitor.azure.com/";
...
console.log(
  "Expected truncation at 40 characters: 'InstrumentationKey=6f15a2b0-1e6e-4f3e-bb8a-...'",
);
console.log();
