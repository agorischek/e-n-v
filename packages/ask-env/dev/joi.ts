...
console.log("This demo shows how to use Joi schemas with ask-env for interactive environment variable collection.");
console.log("The Joi schemas are automatically converted to envcredible schemas.\n");
...
console.log("- NODE_ENV: Must be one of: development, production, test, staging");
...
console.log("- API_KEY: 'short' (too short), 'key with spaces' (invalid chars)");
