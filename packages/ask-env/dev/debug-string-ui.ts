...
// Test the string prompt directly to see the UI
const vars = {
...
// Try to render once to see the initial state
console.log("\n🎨 Initial render:");
try {
  // Force the prompt to render without starting interactive mode
...
// Don't start the interactive prompt, just exit
process.exit(0);