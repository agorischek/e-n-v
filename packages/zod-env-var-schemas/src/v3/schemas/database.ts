...
export const DATABASE_URL_POSTGRESQL = z
  ...
  .regex(POSTGRES_URL_PATTERN, DATABASE_MESSAGES.DATABASE_URL_POSTGRESQL_FORMAT);
...
export const DATABASE_URL_MYSQL = z
  ...
  .regex(MYSQL_URL_PATTERN, DATABASE_MESSAGES.DATABASE_URL_MYSQL_FORMAT);
...
export const DATABASE_URL_MONGODB = z
  ...
  .regex(MONGODB_URL_PATTERN, DATABASE_MESSAGES.DATABASE_URL_MONGODB_FORMAT);
...
export const DATABASE_URL_SQLSERVER = z
  ...
  .refine(
    ...
    DATABASE_MESSAGES.DATABASE_URL_SQLSERVER_FORMAT
  );
...
export const REDIS_URL = z
  ...
  .regex(REDIS_URL_PATTERN, DATABASE_MESSAGES.REDIS_URL_FORMAT);
...
export const DATABASE_URL = z
  ...
  .regex(GENERIC_DATABASE_URL_PATTERN, DATABASE_MESSAGES.GENERIC_DATABASE_URL_FORMAT);
...
export const DATABASE_HOST = z
  ...
  .min(1, DATABASE_MESSAGES.DATABASE_HOST_REQUIRED);
...
export const DATABASE_PORT = z
  ...
  .int(DATABASE_MESSAGES.DATABASE_PORT_INT)
  .min(DATABASE_LIMITS.DATABASE_PORT_MIN, DATABASE_MESSAGES.DATABASE_PORT_MIN)
  .max(DATABASE_LIMITS.DATABASE_PORT_MAX, DATABASE_MESSAGES.DATABASE_PORT_MAX);
...
export const DATABASE_NAME = z
  ...
  .min(1, DATABASE_MESSAGES.DATABASE_NAME_REQUIRED)
  .regex(DATABASE_NAME_PATTERN, DATABASE_MESSAGES.DATABASE_NAME_FORMAT);
...
export const DATABASE_USERNAME = z
  ...
  .min(1, DATABASE_MESSAGES.DATABASE_USERNAME_REQUIRED);
...
export const DATABASE_PASSWORD = z
  ...
  .min(1, DATABASE_MESSAGES.DATABASE_PASSWORD_REQUIRED);
...
export const DATABASE_SCHEMA = z
  ...
  .regex(DATABASE_SCHEMA_PATTERN, DATABASE_MESSAGES.DATABASE_SCHEMA_FORMAT)
  .optional();
...
export const DATABASE_POOL_SIZE = z
  ...
  .int(DATABASE_MESSAGES.DATABASE_POOL_SIZE_INT)
  .min(DATABASE_LIMITS.DATABASE_POOL_SIZE_MIN, DATABASE_MESSAGES.DATABASE_POOL_SIZE_MIN)
  .max(DATABASE_LIMITS.DATABASE_POOL_SIZE_MAX, DATABASE_MESSAGES.DATABASE_POOL_SIZE_MAX)
...
export const DATABASE_TIMEOUT = z
  ...
  .int(DATABASE_MESSAGES.DATABASE_TIMEOUT_INT)
  .min(DATABASE_LIMITS.DATABASE_TIMEOUT_MIN, DATABASE_MESSAGES.DATABASE_TIMEOUT_MIN)
  .max(DATABASE_LIMITS.DATABASE_TIMEOUT_MAX, DATABASE_MESSAGES.DATABASE_TIMEOUT_MAX)
