...
export const AZURE_STORAGE_CONNECTION_STRING = z
  ...
  .regex(
    AZURE_STORAGE_CONNECTION_STRING_PATTERN,
    INFRASTRUCTURE_MESSAGES.AZURE_STORAGE_CONNECTION_STRING_FORMAT,
  );
...
export const AZURE_STORAGE_ACCOUNT_NAME = z
  ...
  .regex(
    AZURE_STORAGE_ACCOUNT_NAME_PATTERN,
    INFRASTRUCTURE_MESSAGES.AZURE_STORAGE_ACCOUNT_NAME_FORMAT,
  );
...
export const AZURE_STORAGE_ACCOUNT_KEY = z
  ...
  .min(1, INFRASTRUCTURE_MESSAGES.AZURE_STORAGE_ACCOUNT_KEY_REQUIRED);
...
export const AZURE_SERVICE_BUS_CONNECTION_STRING = z
  ...
  .regex(
    AZURE_SERVICE_BUS_CONNECTION_STRING_PATTERN,
    INFRASTRUCTURE_MESSAGES.AZURE_SERVICE_BUS_CONNECTION_STRING_FORMAT,
  );
...
export const AZURE_EVENT_HUB_CONNECTION_STRING = z
  ...
  .regex(
    AZURE_EVENT_HUB_CONNECTION_STRING_PATTERN,
    INFRASTRUCTURE_MESSAGES.AZURE_EVENT_HUB_CONNECTION_STRING_FORMAT,
  );
...
export const AWS_SQS_QUEUE_URL = z
  ...
  .regex(AWS_SQS_QUEUE_URL_PATTERN, INFRASTRUCTURE_MESSAGES.AWS_SQS_QUEUE_URL_FORMAT);
...
export const AWS_REGION = z
  ...
  .regex(AWS_REGION_PATTERN, INFRASTRUCTURE_MESSAGES.AWS_REGION_FORMAT);
...
export const AWS_ACCESS_KEY_ID = z
  ...
  .min(
    INFRASTRUCTURE_LIMITS.AWS_ACCESS_KEY_ID_MIN,
    INFRASTRUCTURE_MESSAGES.AWS_ACCESS_KEY_ID_MIN,
  )
  .max(
    INFRASTRUCTURE_LIMITS.AWS_ACCESS_KEY_ID_MAX,
    INFRASTRUCTURE_MESSAGES.AWS_ACCESS_KEY_ID_MAX,
  );
...
export const AWS_SECRET_ACCESS_KEY = z
  ...
  .min(1, INFRASTRUCTURE_MESSAGES.AWS_SECRET_ACCESS_KEY_REQUIRED);
...
export const AWS_S3_BUCKET_NAME = z
  ...
  .regex(
    AWS_S3_BUCKET_NAME_PATTERN,
    INFRASTRUCTURE_MESSAGES.AWS_S3_BUCKET_NAME_FORMAT,
  );
...
export const ELASTICSEARCH_URL = z
  ...
  .url(INFRASTRUCTURE_MESSAGES.ELASTICSEARCH_URL_FORMAT)
  .regex(HTTP_PROTOCOL_PATTERN, INFRASTRUCTURE_MESSAGES.ELASTICSEARCH_URL_PROTOCOL);
...
export const RABBITMQ_URL = z
  ...
  .regex(RABBITMQ_URL_PATTERN, INFRASTRUCTURE_MESSAGES.RABBITMQ_URL_FORMAT);
...
export const KAFKA_BROKERS = z
  ...
  .regex(
    HOST_PORT_LIST_PATTERN,
    INFRASTRUCTURE_MESSAGES.HOST_PORT_LIST_FORMAT,
  );
...
export const KAFKA_CLIENT_ID = z
  ...
  .min(1, INFRASTRUCTURE_MESSAGES.KAFKA_CLIENT_ID_REQUIRED);
...
export const MEMCACHED_SERVERS = z
  ...
  .regex(HOST_PORT_LIST_PATTERN, INFRASTRUCTURE_MESSAGES.HOST_PORT_LIST_FORMAT);
...
export const DOCKER_REGISTRY_URL = z
  ...
  .url(INFRASTRUCTURE_MESSAGES.DOCKER_REGISTRY_URL_FORMAT);
...
export const KUBERNETES_NAMESPACE = z
  ...
  .regex(KUBERNETES_NAME_PATTERN, INFRASTRUCTURE_MESSAGES.KUBERNETES_NAME_FORMAT)
...
export const KUBERNETES_SERVICE_ACCOUNT = z
  ...
  .regex(KUBERNETES_NAME_PATTERN, INFRASTRUCTURE_MESSAGES.KUBERNETES_SERVICE_ACCOUNT_FORMAT)
  .optional();
...
export const PROMETHEUS_PORT = z
  ...
  .int(INFRASTRUCTURE_MESSAGES.PROMETHEUS_PORT_INT)
  .min(
    INFRASTRUCTURE_LIMITS.PROMETHEUS_PORT_MIN,
    INFRASTRUCTURE_MESSAGES.PROMETHEUS_PORT_MIN,
  )
  .max(
    INFRASTRUCTURE_LIMITS.PROMETHEUS_PORT_MAX,
    INFRASTRUCTURE_MESSAGES.PROMETHEUS_PORT_MAX,
  )
...
export const JAEGER_ENDPOINT = z
  ...
  .url(INFRASTRUCTURE_MESSAGES.JAEGER_ENDPOINT_FORMAT)
  .optional();
...
export const NEW_RELIC_LICENSE_KEY = z
  ...
  .length(
    INFRASTRUCTURE_LIMITS.NEW_RELIC_LICENSE_KEY_LENGTH,
    INFRASTRUCTURE_MESSAGES.NEW_RELIC_LICENSE_KEY_LENGTH,
  )
  .optional();
...
export const DATADOG_API_KEY = z
  ...
  .length(
    INFRASTRUCTURE_LIMITS.DATADOG_API_KEY_LENGTH,
    INFRASTRUCTURE_MESSAGES.DATADOG_API_KEY_LENGTH,
  )
  .optional();
...
export const SENTRY_DSN = z
  ...
  .regex(SENTRY_DSN_PATTERN, INFRASTRUCTURE_MESSAGES.SENTRY_DSN_FORMAT)
  .optional();
